 ...
 * @author adzaz
 */
public class DialogEditKeberangkatan extends Dialog {
     ...
     */
    public DialogEditKeberangkatan(JFrame fram) {
        super(fram);
        initComponents();
        setValue();
        fillComboBox();
    ...
    private void setValue(){
        try {
            ...
            txtDate.setText(kb.getTanggal().toString());
            cmbMenu.setSelectedItem(kb.getPaket().getMenu());
            cmbPaket.setSelectedItem(kb.getPaket().getId()+", "+kb.getPaket().getNama());
        }
        } catch (Exception e) {
            e.printStackTrace();
        }

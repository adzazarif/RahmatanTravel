 ...
 * @author adzaz
 */
public class DialogFilterLaporan extends Dialog {

    /**
     * Creates new form DialogFilterLaporan
     */
    public DialogFilterLaporan(JFrame frame) {
        super(frame);
        initComponents();
    }
    ...
    private void btnTerapkanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTerapkanMouseClicked
        LaporanForm.dateStart = txtStart.getText();
        LaporanForm.dateEnd = txtEnd.getText();
        closeMessage();

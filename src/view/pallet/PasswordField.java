    ...
    public PasswordField() {
        ...
        addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent fe) {
                if(animateHinText = getText().equals("")){
                labelText =  apa1;
                } else {
                labelText = apa;
                }
        ...
        eye = new ImageIcon(getClass().getResource("/view/pallet/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/view/pallet/eye_hide.png")).getImage();
